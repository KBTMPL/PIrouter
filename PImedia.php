		...
		<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				<ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
						<a class="<?php if(!isset($_SESSION['guest']) && isset($_SESSION['login'])) { echo('text-danger'); } elseif(isset($_SESSION['guest']) && isset($_SESSION['login'])) { echo('text-warning'); } ?> nav-link active" href="admin.php">PIrouter</a>
                    </li>
